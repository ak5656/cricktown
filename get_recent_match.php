...
function readOldResponse() {
    $fileData = file_get_contents("./getRecentMatchesData.txt") or die("Unable to open file!");
    return $fileData;
}
...
{   $BASEPATH =  __DIR__;
    $myfile = fopen($BASEPATH . "/" .  "getRecentMatchesData.txt", "w") or die("Unable to open file!");
